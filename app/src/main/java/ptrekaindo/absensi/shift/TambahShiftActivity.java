...
public class TambahShiftActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tambah_shift);
        ButterKnife.bind(this);
        context = this;
        Calendar now = Calendar.getInstance();
        //init toolbar
        toolbar.setTitle("Tambah Shift");
